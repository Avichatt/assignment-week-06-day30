...
### Q2 (Coding) — Write code to perform train-test split and scaling
...
**Answer:**
A **Confusion Matrix** is a specific table structure used to evaluate the performance of a classification model. It represents a summary of prediction results on a classification problem. 
